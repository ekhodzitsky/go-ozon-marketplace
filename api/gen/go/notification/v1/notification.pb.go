...
type SendEmailResponse struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// true, если письмо поставлено в очередь или отправлено.
...
const file_proto_notification_v1_notification_proto_rawDesc = "" +
	"\n" +
	"(proto/notification/v1/notification.proto\x12\x0fnotification.v1\x1a\x1bbuf/validate/validate.proto\"k\n" +
	...
	"\x04body\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x04body\"'\n" +
	"\x11SendEmailResponse\x12\x12\n" +
	"\x04sent\x18\x01 \x01(\bR\x04sent2i\n" +
	"\x13NotificationService\x12R\n" +
	"\tSendEmail\x12!.notification.v1.SendEmailRequest\x1a\".notification.v1.SendEmailResponseBVZTgithub.com/ekhodzitsky/go-ozon-marketplace/api/gen/go/notification/v1;notificationv1b\x06proto3"
