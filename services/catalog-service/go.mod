module github.com/ekhodzitsky/go-ozon-marketplace/services/catalog-service
...
require (
	...
	github.com/ekhodzitsky/go-ozon-marketplace/tests v0.0.0-20260611112111-910278e1c9b6
