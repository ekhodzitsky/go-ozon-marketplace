...
func (mr *MockPaymentUsecaseMockRecorder) ProcessPayment(ctx, orderID, userID, amount any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ProcessPayment", reflect.TypeOf((*MockPaymentUsecase)(nil).ProcessPayment), ctx, orderID, userID, amount)
}

// Refund mocks base method.
func (m *MockPaymentUsecase) Refund(ctx context.Context, paymentID uuid.UUID) (*domain.Payment, error) {
	m.ctrl.T.Helper()
...
func (mr *MockPaymentUsecaseMockRecorder) Refund(ctx, paymentID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Refund", reflect.TypeOf((*MockPaymentUsecase)(nil).Refund), ctx, paymentID)
}
